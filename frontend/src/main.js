...
pluralCaseList.push( {plural: "parkings", pascal: "Parking"} )

pluralCaseList.push( {plural: "parkAreas", pascal: "ParkArea"} )
pluralCaseList.push( {plural: "parkingZoneStatuses", pascal: "ParkingZoneStatus"} )

pluralCaseList.push( {plural: "payments", pascal: "Payment"} )


pluralCaseList.push( {plural: "myParkingInfos", pascal: "MyParkingInfo"} )
